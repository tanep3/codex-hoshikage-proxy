...
## 生成画像の自動登録（2026-09-12追加）

Response単位の `GET /v2/codex/responses/{id}/generated-images`、画像登録状態、通知、保持条件は[生成画像API契約](generated-image-api.ja.md)を参照。既存の回答保存完了とは独立し、取得本体は同じv2成果物APIを使う。
